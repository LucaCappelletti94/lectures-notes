...
\NewDocumentCommand{\defaultGraph}{m m m m}{
  ...
  \begin{tikzpicture}
    ...
    \doubleArc{5}{1}{4}[pos=.3, left][pos=.3, right]
    \doubleArc{6}{4}{2}
    \doubleArc{7}{4}{t}

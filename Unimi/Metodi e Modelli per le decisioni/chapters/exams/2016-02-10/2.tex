	...
	\begin{subfigure}{0.45\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				{y^2 + x^2 -6*y - 4*x + 9 <  0 && x < 2 ? x^2 + y - 4*x : NaN};
			\end{axis}
		\end{tikzpicture}
...
Ne otteniamo quindi il punto candidato $C = (1, 2)$ con $\bm{\mu} = \begin{bmatrix}
		\frac{1}{4} \\
		0
	\end{bmatrix}$.
...
Il punto di ottimo locale (minimo) risulta essere $B = (5, 2)$.

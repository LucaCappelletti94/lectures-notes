...
\begin{figure}
  \begin{subfigure}{0.45\textwidth}
    \xygraph{-10}{10}{0}{10}{1.25}{x - y < 0 && -x -y <0 && y > 0}{(x+1)^2 + (y + 0.5)^2}
...
L'unico punto di intersezione esistente è l'origine $O=(0,0)$. Questo punto è \textbf{non regolare} poichè si pone sull'intersezione dei tre vincoli, quindi $O$ è candidato.

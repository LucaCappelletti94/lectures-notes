...
\begin{proof}[Teorema per la periodicità]
  ...
  I cammini \(C_1\) e \(C_2\) formano un ciclo di lunghezza \(u+v\) passante per \(i\), per cui \(d(i)\) è un divisore di \(u+v\). Analogamente esso deve essere un divisore anche per \(u+v+s\) Poiché \(C_1\), \(C\) e \(C_2\) formano un ciclo per \(i\).
  ...
  Poiché \(d(j)\) è il massimo di tali divisore, \(d(i) \leq d(j)\). Ripetendo il ragionamento con \(i\) e \(j\) scambiati, si ottiene che:

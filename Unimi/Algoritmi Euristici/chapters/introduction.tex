...
\begin{multicols}{2}
  \begin{observation}[Euristiche costruttive/distruttive]
  ...
  \end{observation}
  \begin{observation}[Euristiche di ricerca locale]
  ...
  \end{observation}
  \begin{observation}[Euristiche di ricombinazione]
  ...
  \end{observation}
  \begin{observation}[Euristiche a convergenza]

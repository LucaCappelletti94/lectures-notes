...
(pmos1.drain) node[right] {D}
(pmos1.source) node[right] {S};
\draw(0,6)
 node[pmos] (pmos2) {}
(pmos2.gate) node[above] {G}
(pmos2.drain) node[right] {D}
(pmos2.source) node[right] {S};
\draw(0,3)
 node[nmos] (nmos1) {}
(nmos1.gate) node[above] {G}
(nmos1.drain) node[right] {D}
(nmos1.source) node[right] {S};
\draw(0,1)
 node[nmos] (nmos2) {}
(nmos2.gate) node[above] {G}
(nmos2.drain) node[right] {D}
(nmos2.source) node[right] {S};

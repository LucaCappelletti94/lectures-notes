...
\let\oldLemma\lemma
\renewenvironment{lemma}{\colorlet{shadecolor}{MidnightBlue!10}\begin{shaded}\begin{oldLemma}}{\end{oldLemma}\end{shaded}\ignorespacesafterend
}
...
\renewenvironment{proof}{\colorlet{shadecolor}{Green!10}\begin{shaded}\begin{customProof}}{\QED\end{customProof}\end{shaded}\ignorespacesafterend}

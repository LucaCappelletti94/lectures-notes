...
\renewenvironment{theorem}{\colorlet{shadecolor}{Melon!20}\begin{shaded}\begin{oldTheorem}}{\end{oldTheorem}\end{shaded}\ignorespacesafterend}

\let\oldDefinition\definition
\renewenvironment{definition}{\colorlet{shadecolor}{Blue!10}\begin{shaded}\begin{oldDefinition}}{\end{oldDefinition}\end{shaded}\ignorespacesafterend}
...
\renewenvironment{proposition}{\colorlet{shadecolor}{Orange!10}\begin{shaded}\begin{oldProposition}}{\end{oldProposition}\end{shaded}\ignorespacesafterend
}
